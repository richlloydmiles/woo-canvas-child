<?php
/**
 * Template Name: Rooms Archives Page
 *
                    ...
                    <section class="entry">
                        ...
                        ?>
                            ...
                            <?php if ( $loop->have_posts() ) { while ( $loop->have_posts() ) { $loop->the_post(); ?>
                                ...
                                <li><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> - <?php the_time( get_option( 'date_format' ) ); ?>
                                 - <?php echo $post->comment_count; ?> <?php _e( 'comments', 'woothemes' ); ?></li>
